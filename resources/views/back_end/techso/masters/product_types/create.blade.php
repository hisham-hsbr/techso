...
@section('PageHead', 'Product Type Create')

@section('PageTitle', 'Product Type Create')
...
@section('actionTitle', 'Product Type Create')
@section('mainContent')
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                @can('Product Type Create')
                    <form role="form" action="{{ route('product-types.store') }}" method="post"
