...
@section('PageHead', 'Job Status Create')

@section('PageTitle', 'Job Status Create')
...
@section('actionTitle', 'Job Status Create')
@section('mainContent')
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                @can('Job Status Create')
                    <form role="form" action="{{ route('job-statuses.store') }}" method="post" enctype="multipart/form-data"
                        id="quickForm">
                        {{ csrf_field() }}
                        <div class="card-body">
                            <!-- /.card-header -->
