...
@section('PageHead', 'Complaint Create')

@section('PageTitle', 'Complaint Create')
...
@section('actionTitle', 'Complaint Create')
@section('mainContent')
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                @can('Complaint Create')
                    <form role="form" action="{{ route('complaints.store') }}" method="post" enctype="multipart/form-data"
                        id="quickForm">
                        {{ csrf_field() }}
                        <div class="card-body">
                            <!-- /.card-header -->
