...
@section('PageHead', 'Complaint Edit')

@section('PageTitle', 'Complaint Edit')
...
@section('actionTitle', 'Complaint Edit')
@section('mainContent')
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <x-form.form-group-label-input div_class="col-sm-6" label_for="code" lable_class="required"
                                    ...
                                    input_class="" input_value="{{ $complaint->code }}" input_placeholder="Enter code" />
                                <x-form.form-group-label-input div_class="col-sm-6" label_for="name" lable_class="required"
                                    label_name="Complaint Name" input_type="text" input_name="name" input_id="name"
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-sm-10 pl-5 pt-2">
                                <input type="checkbox" class="form-check-input" name="status" value="1" id="status"
                                    @if ($complaint->status == 1) {{ 'checked' }} @endif />
