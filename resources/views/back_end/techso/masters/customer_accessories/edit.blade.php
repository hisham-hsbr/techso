            ...
            <div class="col-md-10">
                @can('{{ $head_name }} Create')
                    {{-- <form role="form" action="{{ route($route_name . '.store') }}" method="post"
                        ...
                        @can('Job Type Edit') --}}
                    <form role="form" action="{{ route($route_name . '.update', $customer_accessories->id) }}" method="post"
                        enctype="multipart/form-data" id="quickForm">
                        {{ csrf_field() }}
                        {{ method_field('PATCH') }}
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <x-form.form-group-label-input div_class="col-sm-6" label_for="code" lable_class="required"
                                    ...
                                    input_class="" input_value="{{ $customer_accessories->code }}"
                                ...
                                <x-form.form-group-label-input div_class="col-sm-6" label_for="name" lable_class="required"
                                    ...
                                    input_style="" input_class="" input_value="{{ $customer_accessories->name }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="col-sm-10 pl-5 pt-2">
                                <input type="checkbox" class="form-check-input" name="status" value="1" id="status"
                                    @if ($customer_accessories->status == 1) {{ 'checked' }} @endif />
