...
@section('pageNavHeader')
    ...
    <li class="breadcrumb-item active">Index</li>ndex</li>
@endsection
        ...
        $(function() {
            var table = $("#example1").DataTable({
                ...
                "fnDrawCallback": function(oSettings) {
                    $('.delete-customer_accessories').on('click', function() {
                        var customerAccessoriesID = $(this).data('customer_accessories_id');
                        var isReady = confirm("Are you sure delete customer accessories");
                        var myHeaders = new Headers({
                            "X-CSRF-TOKEN": $("input[name='_token']").val()
                        });
                        if (isReady) {
                            fetch("/admin/techso/masters/customer-accessories/destroy" +
                                customerAccessoriesID, {
                                    method: 'DELETE',
                                    headers: myHeaders,
