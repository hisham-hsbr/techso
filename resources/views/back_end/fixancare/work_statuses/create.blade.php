...
@section('PageHead', 'Work Status Create')

@section('PageTitle', 'Work Status Create')
...
@section('actionTitle', 'Work Status Create')
@section('mainContent')
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                @can('Work Status Create')
                    <form role="form" action="{{ route('work-statuses.store') }}" method="post"
