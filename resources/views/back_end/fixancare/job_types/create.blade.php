...
@section('PageHead', 'Job Type Create')

@section('PageTitle', 'Job Type Create')
...
@section('actionTitle', 'Job Type Create')
@section('mainContent')
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-10">
                @can('Job Type Create')
                    <form role="form" action="{{ route('job-types.store') }}" method="post" enctype="multipart/form-data"
                        id="quickForm">
                        {{ csrf_field() }}
                        <div class="card-body">
                            <!-- /.card-header -->
